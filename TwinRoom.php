        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Twin Room</h1>
            </div>
          </div>
            ...
            <div id="property-single-carousel" class="swiper">
              <div class="swiper-wrapper">
                <div class="carousel-item-b swiper-slide">
                  <img src="assets/img/twin.jpg" alt="" class="img-fluid">
                </div>
                <div class="carousel-item-b swiper-slide">
                  <img src="assets/img/twin.jpg" alt="" class="img-fluid">
                </div>
              ...
              <div class="col-md-7 col-lg-7 section-md-t3">
                ...
                <div class="property-description">
                  <p class="description color-text-a">
                    Twin rooms are furnished with two single beds placed side by side, offering the flexibility to be utilized as a twin or double room. The inclusion of desks in these rooms makes them an excellent choice for solo business travelers.
                    </p>
                </div>
